...
export MAIL=/var/spool/mail/futzig

# fix Debian PATH, that doesn't include /sbin and /usr/sbin for regular users
...
# set PATH so it includes user's custom paths if it exists
if [ -f ~/.paths ]; then
    . ~/.paths
fi
